    ...
    rows: [
      {
        title: '一行两列',
        cols: [
          {span: 4, label: true, field: 'name'}, {span: 20, field: 'name'}
        ]
      }, {
        title: '一行两列',
        cols: [
          {span: 4, label: true, field: 'loginName'}, {span: 20, field: 'loginName'}
        ]
      }, {
        title: '一行两列',
        cols: [
        ...
        cols: [
          {
            span: 12,
            rows: [{cols: [{span: 6, label: true}, {span: 18}]}, {
              cols: [{
                span: 6,
                label: true
              }, {span: 18}]
            }, {cols: [{span: 6, label: true}, {span: 18}]}]
